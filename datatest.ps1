...
param(
    ...
    [string] $azureConnection1 = "$6",

    [string] $azureConnection2 = "$7",

    [string] $storageConnection = "$8",

    [string] $PiServerConnection = "$9",

    [string] $PiServerConnection1 = "$10",

    [string] $PiServerConnection2 = "$11"
    ...
    $obj.value = {$azureConnection+$azureConnection1+$azureConnection2}
    ...
    $obj.value = {$PiServerConnection+$PiServerConnection1+$PiServerConnection2}
